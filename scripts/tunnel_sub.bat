...
rem compute kernel specific options
rem the Remote Kernels connection method requires the launch command to return immediately
...
rem launch kernel as a background process
